class entities {
    ...
    //set the color of a entities
    setColor(color) {
        this.color = color;
    }
    //set the scale (dimensions) of a entities
    setSize(width, height) {
        this.width = width;
        this.height = height;
    }
    //set the position of a entities
    setPosition(x, y) {
        this.x = x;
        this.y = y;
    }
    ...
    //adds a given velocity to the entitiest in one frame
    setVelocity(speedX, speedY) {
        this.speedX = speedX;
        this.speedY = speedY;
    }
    setColision(entities, callBack) {
        this.collidesWith.push(entities);
